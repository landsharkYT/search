...
The code for this project consists of several Python files, some of which you will need to read and understand in order to complete the assignment, and some of which you can ignore. You can download all the code and supporting files from https://github.com/pisan382/search Links to an external site. 
Files you'll edit:
...
Submit a single zip file named search.zip

    search.py
    searchAgents.py
    README.txt with an explanation of your work for each question to Canvas. Keep your explanations brief.
    autograde.txt - the results from running the autograder.

You can create a zip file using the command line as follows:

$ zip search.zip search.py searchAgents.py README.txt autograde.txt
